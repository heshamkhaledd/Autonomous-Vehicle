...
void UART0_init()
{
    ...
    /* Configure the UART for 115,200, 8 bits, no parity, 1 stop bit operation. */
...
/******************************************************************************
 *
 * Function Name: UART0_sendNumInASCII
 *
 * Description:
 *  A function to convert a decimal value to a string of characters, where each
 *  character holds the ASCII value of it's corresponding digit, then sends this
 *  string through UART0, to be used for debugging purposes on PuTTY terminal.
 *
 * Note: To add this function to the code, define "DEBUG" in this file. 
